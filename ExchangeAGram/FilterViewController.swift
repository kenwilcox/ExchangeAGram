...
class FilterViewController: UIViewController {
  ...
  func createUIAlertController(indexPath:NSIndexPath) {
    ...
    let photoAction = UIAlertAction(title: "Post Photo to Facebook", style: .Destructive) { (UIAlertAction) -> Void in
  ...
  // MARK: - Caching
  func uniquePath(imageNumber: Int) -> String {
  ...
  func cacheImage(imageNumber: Int) {
    let path = uniquePath(imageNumber)
  ...
  func getCachedImage (imageNumber: Int) -> UIImage {
    ...
    var returnedImage = UIImage(contentsOfFile: path)!
